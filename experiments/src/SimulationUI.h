...
public:
    ...
    /*
     * Collect UI commands generated during render
     *
     * Returns all commands that were generated by UI interactions
     * (button clicks, slider changes, etc.) and clears the internal queue.
     *
     * Should be called after render() in the main update loop.
     *
     * @return Vector of UI commands to be processed by controller
     */
...
private:
    ...
    // Command queue for UI interactions
